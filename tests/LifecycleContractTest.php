...
final class LifecycleContractTest extends TestCase
{
    ...
    {
        $input = new PrimaryAskUserInput('input:1', 'submission:1', new HumanActorReference('user:1'), 'user:1', new NamedInputChannel('burdgen'), [new StringInputPart('part:1', 0, 'Maybe auth should be global.')], '2026-08-29T12:00:00Z');
