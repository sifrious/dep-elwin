...
`UserInput` is immutable evidence. `Intent` is a versioned interpretation and `Conversation` is a provider-independent deliberation identity. None imply that executable work exists.
